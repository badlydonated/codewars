...
// are not directly opposite but they become directly opposite after the reduction of "EAST" and "WEST" 
...
//my attempt
//P: take in an array of strings with directional words north east west and south
//R: return an array of strings with 'simplified' directions
//E: see above
//P: not a clue. using a loop and testing for cancelling pairs. n/s, w/e
    //if the array contains north AND south OR west AND east, remove those pairs only

function dirReduc(arr){
   let result = arr.filter((element, index, ar) =>{
        if(ar.includes('NORTH') && ar.includes('SOUTH')){
