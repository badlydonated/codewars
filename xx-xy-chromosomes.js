...
// My attempt
// P: take in a two character string containing either XX or XY 
// R: return a string stating what sex the offspring will be
// E: see above
// P: Use an if statement to compare whether the parameter matches XX or XY. 
    // depending on the result it will return the correct string
