...
//my attempt
//P: take in an array with at least one element. 
//R: return two elements one being the lowest and the 
//  other the highest value of all the elements. 
//E: see above.
//P: if only one element, return the same for both highest and lowest
