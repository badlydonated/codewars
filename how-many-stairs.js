...
// 6152, 5940, 8040, 9174, 7555, 7682, 5252, 8793, 8837, 7320, 8478, 6063, 5751, 9716, 5085, 
// 7315, 7859, 6628, 5425, 6331, 7097, 6249, 8381, 5936, 8496, 6934, 8347, 7036, 6421, 6510, 
...
function stairsIn20(stairs){
    let dailyTotsArr = stairs.map(arr => arr.reduce((sum, item) => sum += item, 0))
    let total = dailyTotsArr.reduce((sum,item) => sum += item,0)
    let twentyYearEst = total * 20
    return twentyYearEst
}
