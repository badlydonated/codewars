...
// p: take in a string containing up to 26 unique alphabetical characters
// r: return a string containing the same characters in alpha order
// e: see above
// p: try turning the string into an array of separate characters and 
//    and sort them by unicode? Then join them and return as one string. 

function sortGiftCode(code){
    return code.split('').sort().join('')
}

console.log(sortGiftCode('drpoklj'))