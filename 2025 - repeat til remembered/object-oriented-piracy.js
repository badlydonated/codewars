...
class Ship {
 ...
 isWorthIt(draft, crew){
    let crewTot = crew * 1.5
    let draftTot = draft - crewTot
    if(draftTot >= 20){
        return true
    }else return false
 }
...
console.log(aWorthyShip.isWorthIt(100,20))

// Codewars solutions
// I need to look at classes more to see the syntax for methods and using 'this'
